...
public class WeeklyUsageController {
    ...
    public ResponseEntity<WeeklyUsageMessage> getWeeklyUsage(@PathVariable("id") Long id){
        log.info("user id에 따른 주간 사용시간 통계: " + id);
        return weeklyUsageService.getWeeklyUsageById(id);
    }
